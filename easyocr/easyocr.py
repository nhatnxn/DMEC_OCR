...
from easyocr.paddle_detector import text_detector
...
class Reader(object):
    ...
    def readtext(self, image, decoder = 'greedy', beamWidth= 5, batch_size = 1,\
        ...
        for i,res in enumerate(result):
            ...
            cv2.putText(image, str(i+1), (int(box[0][0])-10, int(box[0][1])), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (36,255,12), 1)
            cv2.imwrite('img_7.jpg', image)
